...
public class StatusStreamHandler implements EventChannel.StreamHandler {
    ...
    private MeetingServiceListener listener;
    ...
    public void onListen(Object arguments, final EventChannel.EventSink events) {
        listener = new MeetingServiceListener() {
            @Override
       ...
       this.meetingService.addListener(listener);
    }

    @Override
    public void onCancel(Object arguments) {
        this.meetingService.removeListener(listener);
    }
